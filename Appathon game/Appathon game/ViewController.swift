...
//  Appathon game
//
//  Created by Vishnu vardhan on 10/03/22.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for _ in 1...16{
            ...
            let metalMateriel = SimpleMaterial(color: .gray, isMetallic: true)
           
            let model = ModelEntity(mesh: box, materials: [metalMateriel])
        ...
        cancellable = ModelEntity.loadModelAsync(named: "01")
            ...
            .append(ModelEntity.loadModelAsync(named: "14"))
            .append(ModelEntity.loadModelAsync(named: "07"))
            .append(ModelEntity.loadModelAsync(named: "13"))
            .append(ModelEntity.loadModelAsync(named: "09"))
            .append(ModelEntity.loadModelAsync(named: "10"))
            .collect()
